    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_image_product', to='product.product')),
            ],
        ),
        migrations.AddField(
            model_name='product',
            name='coverImage',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_cover_image', to='product.productimage'),
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('dateCreated', models.DateTimeField(auto_now_add=True)),
                ('billing', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='order_billing', to='product.billing')),
        ...
        migrations.AddField(
            model_name='billing',
            name='order',
            field=models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='billing_order', to='product.order'),
        ),
    ]
